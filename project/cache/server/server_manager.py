...
class Server:
    ...
    def __init__(self, path: Path):
        ...
        self.cfg_path = self.project_path / "cache" / "server" / "server_cache.toml"
        _ = self.server_toml
    ...
    class AzureUser:
        ...
        @cached_property
        def azure_cli(self):
            docker_file_path = Path(r"C:\Users\miles\PycharmProjects\mileslib\virtual_machines\Dockerfile.user")
